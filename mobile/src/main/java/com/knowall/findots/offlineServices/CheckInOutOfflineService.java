...
public class CheckInOutOfflineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        CheckInCheckOutOfflineRestCall restCall = new CheckInCheckOutOfflineRestCall(CheckInOutOfflineService.this);
        
            restCall.callCheckInOutOfflineService(intent.getBooleanExtra("checkinStatus",false));
