...
public enum LocationRequestData {
    FREQUENCY_HIGH(5000*60, 5000*60, LocationRequest.PRIORITY_HIGH_ACCURACY, 300.0f),
    FREQUENCY_MEDIUM(5 * 60 * 1000, 5 * 60 * 1000, LocationRequest.PRIORITY_HIGH_ACCURACY, 500f),
